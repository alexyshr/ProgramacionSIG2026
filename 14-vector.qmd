...
## Extracción estructurada de coordenadas en topologías complejas (OLD: Revisar Luego)
...
# Estructura: [(exterior_pol1, [huecos_pol1]), (exterior_pol2, [huecos_pol2])]
mpol_reserva = MultiPolygon([
    (ext_reserva, [int_laguna1, int_laguna2]), 
    (ext_isla, [])
])
...
# 2. Ensamblaje en lista jerárquica (MULTIPOLYGON) - Objeto SFG
mpol_reserva <- st_multipolygon(list(
  list(ext_reserva, int_laguna1, int_laguna2), # Pol 1: Exterior y dos huecos
  list(ext_isla)                               # Pol 2: Exterior únicamente (Isla)
))
...
1. Descargue el binario (jts-1.14.zip).  
