...
## Control de Versiones: Flujo de Trabajo en Terminal {#sec-git-terminal}
...
## Subír el contenido existende de una carpeta local a un repositorio vacío en GitHub
...
* **Forzar archivos** y/o carpetas que están marcados para ignorar (bandera `-f`): el comando a continuación sincronizará con Git toda la carpeta `_site/site_libs/` y su contenido, así contenga archivos `pdf` o `html` (marcados para ignorar en `.gitignore`) {#ancla-git_add_minus_f}
...
## Autenticación Segura: Configuración de Llaves SSH en GitHub {#sec-ssh-github}
...
### Requitiso Previo: Creación de Cuenta en GitHub
...
## Vinculación del Repositorio de Contenidos de la Clase{#sec-vinculacion-clase}

Los contenidos de la clase están en `https://github.com/alexyshr/ProgramacionSIG2026.git` (HTTPS) o `git@github.com:alexyshr/ProgramacionSIG2026.git` (SSH). La elección de uno de estos dos protocolos (HTTPS o SSH), depende de si ha configurado su identidad digital, ver @sec-ssh-github.
