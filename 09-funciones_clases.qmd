...
![**El paradigma de Python (POO Clásica):** La Clase actúa como una fábrica o molde que estampa objetos. Cada objeto (la arepa) no solo contiene datos, sino que lleva incrustadas sus propias herramientas y métodos (como la navaja suiza o la calculadora) para resolver problemas por sí mismo.](./images/python_classes_analogy.png){#fig-analogia-python fig-align="center" width="85%"}
...
![**Analogía de los motores de ejecución:** El Food Truck autónomo (Python), la lenta Oficina de Correos de revisión manual (R) y la veloz Fábrica Industrial Láser (Julia).](./images/comparativa_despacho_python_r_julia.png){#fig-analogia-motores fig-align="center" width="100%"}
