...
XXX Falta: explicar el contenido del archivo (u10) de goodland_10u_1.nc
U es la componente este-oeste (zonal)
...
# Nota: estos comandos de configuración del plot no tienen efecto
#       al plotear objetos stars
par(mar = c(
...
Podemos usar sf::st_crs para asignar coordenadas el cubo sin cargar `sf`. Es decir solo con `library(stars)` se habilitan las funciones de `sf` las cuales muchas sirven para aplicarlas a cubos raster.
