...
Dentro de la carpeta deben existir los archivos descargados en el paso anterior:
   ...
   - `sig_unal_v1.11_completo_final.tar` (El archivo de la imagen).
...
Estando Docker Desktop abierto, desde una terminal situada en la carpeta que contiene `sig_unal_v1.11_completo_final.tar` y `docker-compose.yml`, ejecute:

```bash
docker load -i sig_unal_v1.11_completo_final.tar
```
