...
## Infraestructura a instalar {#sec-infraestructura}
...
::: {.callout-tip}
### Importante
Si desea verificar si estos cambios surtieron efecto dentro de su laboratorio, puede ejecutar el comando `free -h` en la terminal de Jupyter o VSCode. Esto le mostrará la memoria total y el espacio de Swap disponible tal como se configuró en el [Anexo de Referencia Técnica](#swap-ref).
:::
...
9.  **Acceso y Configuración en VSCode**: 
