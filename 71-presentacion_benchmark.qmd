---
title: "Benchmark geoespacial: cómo leer los resultados"
subtitle: "Una comparación de stacks, no de lenguajes"
...
## ¿Qué hace exactamente el benchmark?
...
## Modelos de ejecución comparados
...
- **R / terra**  
  Raster algebra optimizado en C++ y procesamiento por bloques, pero sin exponer un pipeline diferido composable
...
## Niveles de abstracción por motor
...
## ¿Qué es lo importante hoy (y qué no)?
