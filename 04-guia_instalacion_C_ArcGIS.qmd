...
Una vez configurado el entorno y descargada la caja de herramientas, procede a inicializar Earth Engine dentro de la interfaz de ArcGIS Pro.  Para ver el paso a paso, consulta la sección @sec-arcgis-pro-initialize-gee.
...
* 🌍 **Google Earth Engine Data Catalog**
    ...
    * Operado mediante la caja de herramientas integrada. Ver @sec-arcgis-pro-gee y @sec-arcgis-pro-gee-start.