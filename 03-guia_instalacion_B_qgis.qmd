...
1. Abre QGIS usando `pixi run qgis`
2. Ve al menú **Complementos** $\rightarrow$ **Administrar e instalar complementos...**
...
8. Ve a la pestaña **Todos**.
9. Busca **"Earth Engine Data Catalogs"**.
10. Selecciona **"Earth Engine Data Catalogs"** en la lista y haz clic en **Instalar complemento**.
...
#### Actualizar el plugin dentro de QGIS

En el manú `GEE Data Catalogs`, asegúrece de ejecutar `Check for Updates`.
